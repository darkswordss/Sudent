//
// Created by Jose Guerrero on 2/1/20.
//
...
TEST_CASE("studentDB insert", "[points:1]") {
...
TEST_CASE("studentDB erase", "[points:1]") {
cop3530::student_db database;
database.insert(1, "Albert", 3.5);
database.insert(2, "Alberta", 4.0);
...
TEST_CASE("studentDB size", "[points:1]") {
cop3530::student_db database;
...
TEST_CASE("studentDB empty", "[points:1]") {
cop3530::student_db database;
...
TEST_CASE("studentDB get_all_students", "[points:1]") {
cop3530::student_db database;
CHECK(database.empty());
